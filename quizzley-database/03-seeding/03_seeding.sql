-- ==========================================================
-- 12. DEFAULT SEED DATA - MAIN PLATFORM DB
-- ==========================================================
...
-- ==========================================================
-- 12. DEFAULT SEED DATA - QUESTIONS DB
-- ==========================================================
USE quiz_questions_db;

-- Quiz 1 belongs to Database Systems (DBS101), so questions go into questions_dbs101.
INSERT INTO questions_dbs101 (question_id, quiz_id, question_text, question_type, marks, hint, explanation, is_active)
VALUES
    (1, 1, 'What is the value of x if 2x + 7 = 15?', 'MCQ', 2.00, 'Subtract 7 from both sides first.', '2x = 15 - 7 => 2x = 8 => x = 4.', TRUE),
    (2, 1, 'True or False: The equation x^2 + 1 = 0 has real solutions.', 'TRUE_FALSE', 1.00, 'Think about square of any real number.', 'The square of any real number is non-negative, so x^2 + 1 >= 1.', TRUE),
    (3, 1, 'Solve for x: 3(x - 2) = 12.', 'SHORT_ANSWER', 2.00, 'Distribute or divide by 3 first.', 'Divide by 3: x - 2 = 4 => x = 6.', TRUE);

-- Options for Question 1 (x=4 is correct)
INSERT INTO question_options_dbs101 (question_id, option_text, is_correct)
VALUES
    (1, 'x = 3', FALSE),
    (1, 'x = 4', TRUE),
    (1, 'x = 5', FALSE),
