...
-- MySQL Constraints & Performance Indexes
-- ==========================================================
...
=======
CREATE INDEX idx_module_specializations_module_id ON module_specializations (module_id);
CREATE INDEX idx_module_specializations_specialization_id ON module_specializations (specialization_id);
>>>>>>> Stashed changes
...
=======
CREATE INDEX idx_quiz_assignments_specialization_id ON quiz_assignments (specialization_id);
CREATE INDEX idx_quiz_assignments_batch_id ON quiz_assignments (batch_id);
...
=======
CREATE INDEX idx_group_members_group_quiz_id ON group_members (group_quiz_id);
