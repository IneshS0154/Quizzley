...
export default function AdminDashboardPage() {
  ...
  // Stats definition
  const stats = [
    { label: 'Total Quizzes', value: '0', trend: '—', type: 'blue' },
    { label: 'Active Quizzes', value: '0', trend: '—', type: 'indigo' },
    { label: 'Completed Submissions', value: '0', trend: '—', type: 'green' },
    { label: 'Avg System Score', value: '—', trend: '—', type: 'red' }
  ];

  // Managed quizzes rows
  const quizzesData = [];
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="flex items-center space-x-3 pl-4 border-l border-slate-100">
            <div className="text-right">
              ...
              <div className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">System Manager</div>
            </div>
      ...
      <div className="p-8 sm:p-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 pb-6 border-b border-slate-200/50">
          ...
          <div className="mt-4 sm:mt-0 flex items-center space-x-3">
            ...
            <button className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-xl shadow-md shadow-blue-500/10 hover:shadow-blue-500/20 active:bg-blue-800 transition-all flex items-center space-x-2">
