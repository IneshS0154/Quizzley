...
export default function MyQuizzesPage({ setCurrentPage, setLastResult }) {
  ...
  //   quiz***
  // return (
  //   <div className="flex-1 bg-slate-50 min-h-screen p-8 sm:p-10 relative">
  //     {/* Header Row */}
  ...
  //         <p className="text-sm text-slate-500 mt-1 font-medium">View and attempt your quizzes</p>
  //       </div>
  ...
  //           className="w-full pl-11 pr-4 py-2.5 bg-white border border-slate-200 rounded-xl text-slate-800 placeholder-slate-450 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition-all text-sm shadow-sm"
  //         />
  //       </div>
  //     </div>
  ...
  //           <div 
  //             key={quiz.id}
  //             className="bg-white border border-slate-100 p-5 rounded-2xl shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:border-slate-200 transition-all"
  //           >
  //             {/* Info Column */}
  ...
  //                 <p className="text-xs font-semibold text-slate-400 mt-1 flex items-center space-x-2">
  ...
  //                 className={`px-5 py-2.5 text-xs font-bold rounded-xl transition-all cursor-pointer ${quiz.actionClass}`}
  //               >
  //                 {quiz.actionLabel}
  //               </button>
  //             </div>
  ...
  //                   className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-blue-500/10 hover:shadow-blue-500/20 disabled:opacity-50 transition-all cursor-pointer text-sm"
  //                 >
  //                   Submit Quiz
  //                 </button>
  //               </form>
  ...
  //                 <div className="w-16 h-16 bg-green-50 text-green-500 rounded-full flex items-center justify-center mx-auto mb-4 border border-green-200/50">
  ...
  //                 <div className="bg-slate-50 border border-slate-100 rounded-2xl p-4 mt-6 max-w-xs mx-auto">
  ...
  //                       setCurrentPage('results');
  //                     }}
  //                     className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-xl shadow-md transition-all cursor-pointer text-sm"
  //                   >
  //                     View Detailed Review
  //                   </button>
  //                   <button
  //                     onClick={() => setShowQuizModal(false)}
  //                     className="w-full border border-slate-200 text-slate-700 font-bold py-3 rounded-xl hover:bg-slate-50 transition-all cursor-pointer text-sm"
  //                   >
  //                     Back to Quizzes
  //                   </button>
  //                 </div>
