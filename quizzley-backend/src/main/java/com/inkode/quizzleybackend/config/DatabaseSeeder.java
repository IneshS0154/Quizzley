    ...
    public void run(String... args) throws Exception {
        try {
            ...
            for (Map<String, Object> m : modulesList) {
                ...
                String tableName = code.replaceAll("[^a-zA-Z0-9_]", "").toLowerCase() + "_questions";
            ...
            try {
                Integer dbsCount = jdbcTemplate.queryForObject("SELECT COUNT(*) FROM dbs101_questions", Integer.class);
                if (dbsCount == null || dbsCount == 0) {
                    ...
                    if (!quizIds.isEmpty()) {
                        ...
                        jdbcTemplate.update("INSERT INTO dbs101_questions (quiz_id, question_text, question_type, marks, is_active, options_json) VALUES (?, ?, 'MCQ', 2.0, 1, ?)",
